...
public class MessagesReceivedAdapter extends RecyclerView.Adapter<MessagesReceivedAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public MessagesReceivedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MessagesReceivedAdapter.ViewHolder viewHolder, int i) {
